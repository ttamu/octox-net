...
pub enum Error {
    ...
    InvalidAddress = -41,
    Timeout = -42,
    NoSocketAvailable = -43,
    InvalidSocketIndex = -44,
    InvalidSocketState = -45,
    PortInUse = -46,
    NoPortAvailable = -47,
    InvalidLength = -48,
    NoMatchingSocket = -49,
...
impl Error {
    pub fn as_str(&self) -> &'static str {
        ...
        match *self {
            ...
            Timeout => "timeout",
            NoSocketAvailable => "no socket available",
            InvalidSocketIndex => "invalid socket index",
            InvalidSocketState => "invalid socket state",
            PortInUse => "port in use",
            NoPortAvailable => "no port available",
            InvalidLength => "invalid length",
            NoMatchingSocket => "no matching socket",
    ...
    pub fn from_isize(code: isize) -> Self {
        ...
        match code {
            ...
            -41 => InvalidAddress,
            -42 => Timeout,
            -43 => NoSocketAvailable,
            -44 => InvalidSocketIndex,
            -45 => InvalidSocketState,
            -46 => PortInUse,
            -47 => NoPortAvailable,
            -48 => InvalidLength,
            -49 => NoMatchingSocket,
